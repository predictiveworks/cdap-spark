...
public class ChiSquaredRecorder extends AbstractModelManager {

	private String ALGORITHM_NAME = "ChiSquared";

	public ChiSqSelectorModel read(SparkExecutionPluginContext context, String modelName) throws Exception {
	...
	private ChiSqSelectorModel read(FileSet fs, Table table, String modelName) throws IOException {
		...
		return ChiSqSelectorModel.load(modelPath);
	...
	private void save(FileSet modelFs, Table modelMeta, String modelName, String modelParams, String modelMetrics,
		...
		/*
		 * Leverage Apache Spark mechanism to write the Chi Squared Selector model
