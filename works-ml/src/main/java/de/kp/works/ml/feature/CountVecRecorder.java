...
public class CountVecRecorder extends AbstractModelManager {
	...
	private CountVectorizerModel read(FileSet fs, Table table, String modelName) throws IOException {
