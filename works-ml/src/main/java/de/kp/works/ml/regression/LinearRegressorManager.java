...
public class LinearRegressorManager extends AbstractRegressionManager {
	...
	private LinearRegressionModel read(FileSet fs, Table table, String modelName) throws IOException {
