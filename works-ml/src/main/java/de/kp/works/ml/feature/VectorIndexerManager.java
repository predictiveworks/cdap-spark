...
public class VectorIndexerManager extends AbstractModelManager {

	private String ALGORITHM_NAME = "VectorIndexer";

	public VectorIndexerModel read(FileSet fs, Table table, String modelName) throws IOException {
