...
public class NBClassifierManager extends AbstractClassificationManager {
	...
	private NaiveBayesModel read(FileSet fs, Table table, String modelName) throws IOException {
