...
/**
  * RedisEndpoint represents a redis connection endpoint info: 
  * host, port, auth password db number, timeout and ssl mode
  *
...
case class RedisEndpoint(
   ...
   ssl:Boolean = false) extends Serializable {

  /**
    * Constructor from SparkConf. Set params with 
    * 
    * - spark.redis.host, 
    * - spark.redis.port, 
    * - spark.redis.auth, 
