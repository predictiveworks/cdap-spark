...
public class SpellRecorder extends AbstractModelManager {

	private String ALGORITHM_NAME = "NorvigSweeting";

	public NorvigSweetingModel read(SparkExecutionPluginContext context, String modelName) throws Exception {
	...
	public NorvigSweetingModel read(FileSet fs, Table table, String modelName) throws IOException {
	...
	private void save(FileSet fs, Table table, String modelName, String modelParams, String modelMetrics,
			NorvigSweetingModel model) throws IOException {
		...
		/*
		 * Leverage Apache Spark mechanism to write the NorvigSweeting model
