...
public class Algorithms {
	...
	public final static String DECISION_TREE = "DecisionTree";
	public final static String GAUSSIAN_MIXTURE = "GaussianMixture";
	public final static String GENERALIZED_LINEAR_REGRESSION = "GeneralizedLinearRegression";
	public final static String GRADIENT_BOOSTED_TREE = "GradientBoostedTree";
	public final static String ISOTONIC_REGRESSION = "IsotonicRegression";
	public final static String KMEANS = "KMeans";
	public final static String LATENT_DIRICHLET_ALLOCATION = "LatentDirichletAllocation";	
	public final static String LINEAR_REGRESSION = "LinearRegression";
	public final static String LOGISTIC_REGRESSION = "LogisticRegression";
	public final static String MULTI_LAYER_PERCEPTRON = "MultiLayerPerceptron";
	public final static String NAIVE_BAYES = "NaiveBayes";
