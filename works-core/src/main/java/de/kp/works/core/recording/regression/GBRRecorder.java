...
public class GBRRecorder extends RegressorRecorder {
	...
	public GBRRecorder(ConfigReader configReader) {
		super(configReader);
		algoName = Algorithms.GRADIENT_BOOSTED_TREE;
	}

	public GBTRegressionModel read(SparkExecutionPluginContext context, String modelName, String modelStage, String modelOption) throws Exception {
